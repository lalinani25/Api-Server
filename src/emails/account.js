...
const sendVerificationEmail = (toEmail, username, token) => {
    sendOneButtonEmail({
        to: toEmail,
        from: { name: 'The Study Buddy', email: 'alinanilaura09@gmail.com' },
        subject: 'Welcome to The Study Buddy!',
        imgURL: 'http://cdn.mcauto-images-production.sendgrid.net/9fdee810147efd1c/a24f168a-9828-4193-9da3-c34eff3990ee/1470x980.png',
        firstLine: `Thanks for signing up, ${username}!`,
        secondLine: 'Please verify your email address to begin studying with buddies.',
        thirdLine: 'Thank you!',
        buttonURL: `https://thankful-plant-0f567c30f.4.azurestaticapps.net/verify.html?token=${token}`,
